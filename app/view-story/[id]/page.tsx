...
import { ArrowLeft, ChevronLeft, ChevronRight, BookOpen ,PauseCircleIcon} from 'lucide-react';
            ...
            {parsedStory.chapters?.map((chapter: Chapter, index: number) => (
              ...
              >
                <div className="mb-4">
                  ...
                  {/* Audio */}
                  <span className="absolute top-4 left-4 z-10 blue-300">
                  {speakingIndex === index ? (
  <PauseCircleIcon
    className="text-3xl cursor-pointer"
    onClick={() => toggleSpeech(chapter.text, index)}
  />
) : (
  <IoPlayCircleSharp
    className="text-3xl cursor-pointer"
